            ...
            <section class="flex gap-10">
                <div class="flex flex-col w-full gap-2">
                    ...
                    <?php for ($i = 0; $i < count($stocks); $i++): ?>
                        <a href="index.php?page=investment&action=buy&type=stocks&id=<?= $stocks[$i][0] ?>"
                ...
                <div class="flex flex-col w-full gap-2">
                    ...
                    <?php for ($i = 0; $i < count($bonds); $i++): ?>
                        <a href="index.php?page=investment&action=buy&type=bonds&id=<?= $bonds[$i][0] ?>"
                            class="flex items-center justify-between p-2 rounded-xl cursor-pointer hover:bg-slate-200/75">
                            <span class="flex gap-4 items-center">
            ...
            <section class="flex gap-10">
                <div class="flex flex-col w-full gap-2">
                    ...
                    <?php for ($i = 0; $i < count($currency); $i++): ?>
                        <a href="index.php?page=investment&action=buy&type=currency&id=<?= $currency[$i][0] ?>"
                            class="flex items-center justify-between p-2 rounded-xl cursor-pointer hover:bg-slate-200/75">
                            <span class="flex gap-4 items-center">
                ...
                <div class="flex flex-col w-full gap-2">
                    ...
                    <?php for ($i = 0; $i < count($metals); $i++): ?>
                        <a href="index.php?page=investment&action=buy&type=metals&id=<?= $metals[$i][0] ?>"
                            class="flex items-center justify-between p-2 rounded-xl cursor-pointer hover:bg-slate-200/75">
                            <span class="flex gap-4 items-center">
